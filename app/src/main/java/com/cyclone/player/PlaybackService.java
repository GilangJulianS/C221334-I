...
import com.cyclone.player.media.MediaUtils;
...
import com.cyclone.player.util.FileUtils;
...
public class PlaybackService extends Service implements IVLCVout.Callback, IgetCoverUrl {
    ...
    private void showNotification() {
        ...
        try {
            ...
            builder.addAction(R.drawable.ic_skip_previous_white_36dp, getString(R.string.previous), piBackward);
            if (mMediaPlayer.isPlaying())
                builder.addAction(R.drawable.ic_pause_white_36dp, getString(R.string.pause), piPlay);
            else
                builder.addAction(R.drawable.ic_play_arrow_white_36dp, getString(R.string.play), piPlay);
            builder.addAction(R.drawable.ic_skip_next_white_36dp, getString(R.string.next), piForward);
    ...
    public void next() {
        ...
        if (size == 0 || mCurrentIndex < 0 || mCurrentIndex >= size) {
            ...
            LocalBroadcastManager.getInstance(this).sendBroadcast(new Intent(Strings.buildPkgString("gui.video.EXIT_PLAYER")));
            stop();
            return;
        }
        playIndex(mCurrentIndex, 0);
