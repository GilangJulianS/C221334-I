...
public class AudioService extends Service {
    ...
    public void onDestroy() {
        ...
        DrawerActivity.showMiniPlayer = false;
        ...
        public boolean reloadQueue() throws RemoteException {
            mLibVLC.getMediaList().clear();
             for(int i = 0; i< myQueue.size(); i++){
                mLibVLC.getMediaList().add(myQueue.getMedia(i));
            ...
            MediaDatabase db = MediaDatabase.getInstance();
            for(int i = 0; i< myQueue.size(); i++){
                mediaList.add(myQueue.getMedia(i));
                System.out.println("addddddddd");
            }
    ...
    public static void loadMedia(List<Media> mediaList){
        System.out.println("]]]]]]]]]]]]]]]]]]]]]]load media from service]]] total: "+mediaList.size());
       // System.out.println("]]]]]]]]]] size :"+myQueue.size());
        myQueue = new MediaList(LibVLC.getExistingInstance());
        try{
            myQueue.clear();
        }catch (Exception e){}
