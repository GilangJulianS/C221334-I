...
import com.cyclone.player.interfaces.IAudioPlayerControl;
...
public class AudioServiceController implements IAudioPlayerControl {
    ...
    public boolean reloadQueue() {
        return remoteProcedureCall(mAudioServiceBinder, boolean.class, false, "reloadQueue", null, null);
    }

    public void loadMedia(List<Media> mediaList){

        System.out.println("]]]]]]]]]]]]]]]load media on audio controller");
        AudioService.loadMedia(mediaList);
