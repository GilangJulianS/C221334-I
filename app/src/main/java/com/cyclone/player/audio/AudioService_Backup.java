...
public class AudioService_Backup{ //extends Service {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            *//*
            ...
            if (action.startsWith(ACTION_REMOTE_GENERIC) && !mLibVLC.isPlaying() && !hasCurrentMedia()) {
                Intent iVlc = new Intent(context, DrawerActivity.class);
    ...
    *//**
    ...
    private static class AudioServiceEventHandler extends WeakHandler<AudioService_Backup> {
        public AudioServiceEventHandler(AudioService_Backup fragment) {
            super(fragment);
        }

        @Override
        public void handleMessage(Message msg) {
            AudioService_Backup service = getOwner();
    ...
    private static class MediaListEventHandler extends WeakHandler<AudioService_Backup> {
        // Don't clobber mCurrentIndex when MediaList is expanding itself.
        boolean expanding = false;

        public MediaListEventHandler(AudioService_Backup audioService) {
            super(audioService);
        }
    ...
    *//**
    ...
    private static class AudioServiceHandler extends WeakHandler<AudioService_Backup> {
        public AudioServiceHandler(AudioService_Backup fragment) {
            super(fragment);
        }
    ...
    private void showNotification() {
        try {
            ...
            if (LibVlcUtil.isJellyBeanOrLater()) {
                ...
                view.setImageViewBitmap(R.id.cover, cover == null ? BitmapFactory.decodeResource(getResources(), R.drawable.radio_icon) : cover);
                view.setTextViewText(R.id.songName, title);
                view.setTextViewText(R.id.artist, artist);
                view.setImageViewResource(R.id.play_pause, mLibVLC.isPlaying() ? R.drawable.ic_pause_white_48dp : R.drawable.ic_play_arrow_white_48dp);
                ...
                view_expanded.setImageViewBitmap(R.id.cover, cover == null ? BitmapFactory.decodeResource(getResources(), R.drawable.ic_assignment_return_black_18dp) : cover);
                ...
                view_expanded.setImageViewResource(R.id.play_pause, mLibVLC.isPlaying() ? R.drawable.ic_pause_white_48dp : R.drawable.ic_play_arrow_white_48dp);
                ...
                builder.setLargeIcon(cover == null ? BitmapFactory.decodeResource(getResources(), R.drawable.radio_icon) : cover)
            ...
            startService(new Intent(this, AudioService_Backup.class));
    ...
    *//**
    ...
    private final IAudioService.Stub mInterface = new IAudioService.Stub() {
        ...
        public void pause() throws RemoteException {
            AudioService_Backup.this.pause();
        }

        @Override
        public void play() throws RemoteException {
            AudioService_Backup.this.play();
        }

        @Override
        public void stop() throws RemoteException {
            AudioService_Backup.this.stop();
        }
        ...
        public String getAlbum() throws RemoteException {
            if (hasCurrentMedia())
                return Util.getMediaAlbum(AudioService_Backup.this, getCurrentMedia());
            else
                return null;
        }
        ...
        public String getArtist() throws RemoteException {
            if (hasCurrentMedia()) {
                ...
                return media.isArtistUnknown() && media.getNowPlaying() != null ?
                        media.getNowPlaying()
                        : Util.getMediaArtist(AudioService_Backup.this, media);
            } else
                return null;
        }
        ...
        public String getArtistPrev() throws RemoteException {
            if (mPrevIndex != -1)
                return Util.getMediaArtist(AudioService_Backup.this, mLibVLC.getMediaList().getMedia(mPrevIndex));
            else
                return null;
        }
        ...
        public String getArtistNext() throws RemoteException {
            if (mNextIndex != -1)
                return Util.getMediaArtist(AudioService_Backup.this, mLibVLC.getMediaList().getMedia(mNextIndex));
            else
                return null;
        }
        ...
        public Bitmap getCover() {
            if (hasCurrentMedia()) {
                return AudioService_Backup.this.getCover();
            }
            return null;
        }
        ...
        public Bitmap getCoverPrev() throws RemoteException {
            if (mPrevIndex != -1)
                return AudioUtil.getCover(AudioService_Backup.this, mLibVLC.getMediaList().getMedia(mPrevIndex), 64);
            else
                return null;
        }
        ...
        public Bitmap getCoverNext() throws RemoteException {
            if (mNextIndex != -1)
                return AudioUtil.getCover(AudioService_Backup.this, mLibVLC.getMediaList().getMedia(mNextIndex), 64);
            else
                return null;
        }
        ...
        *//**
        ...
        public void load(List<String> mediaPathList, int position, boolean noVideo)
            ...
            for (int i = 0; i < mediaPathList.size(); i++) {
                ...
                System.out.println("AUDIO SERVICE : "+media.getTitle());
                if(media == null) {
            ...
            setUpRemoteControlClient();
            showNotification();
            updateWidget(AudioService_Backup.this);
            updateRemoteControlClientMetadata();
            AudioService_Backup.this.saveMediaList();
            AudioService_Backup.this.saveCurrentMedia();
            determinePrevAndNextIndices();
        }
        ...
        *//**
        ...
        public void next() throws RemoteException {
            AudioService_Backup.this.next();
        }

        @Override
        public void previous() throws RemoteException {
            AudioService_Backup.this.previous();
        }

        @Override
        public void shuffle() throws RemoteException {
            AudioService_Backup.this.shuffle();
        }

        @Override
        public void setRepeatType(int t) throws RemoteException {
            AudioService_Backup.this.setRepeatType(t);
        }
        ...
        @Override
        public boolean reloadQueue() throws RemoteException {
