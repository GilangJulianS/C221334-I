...
import com.cyclone.player.util.MurmurHash;
...
public class AudioUtil {
    ...
    public static final BitmapDrawable DEFAULT_COVER = new BitmapDrawable(VLCApplication.getAppResources(), BitmapCache.getFromResource(VLCApplication.getAppResources(), R.drawable.radio_icon));
