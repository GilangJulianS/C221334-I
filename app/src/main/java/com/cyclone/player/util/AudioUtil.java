...
public class AudioUtil {
    ...
    public synchronized static Bitmap getCover(Context context, Media media, int width) {
        ...
        try {
            ...
            if(!isLoadImage){
                System.out.println("AUDIO UTIL,,,,,,,,,,,,,,,,,,,gggggggggggggggg,,,,,,,,,,,,,,,");
                new ImageLoadTask(media.getArtworkURL(),context, coverPath, cachePath, width).execute();
            }
...
*/
        ...
        /*if(cover == null){
            cover = BitmapFactory.decodeResource(context.getResources(),R.drawable.radio_icon);
        }*/
        return cover;
    }
    ...
    private static class ImageLoadTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        public ImageLoadTask(String url,Context context, String coverPath, String cachePath, int width) {
            this.url = url;
        ...
        protected void onPostExecute(Bitmap result) {
           ...
           // cover = readCoverBitmap(context, coverPath, width);
            ...
            cover = readCoverBitmap(context, cachePath, width);

            System.out.println("AUDIO UTIL ONPOST");
            isLoadImage = false;
        }
