...
package com.cyclone.player.widget;
...
abstract public class VLCAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_WIDGET_INIT.equals(action) || !partial) {
            ...
            Intent iVlc = new Intent(VLCApplication.getAppContext(), DrawerActivity.class);
        ...
        if (ACTION_WIDGET_UPDATE.equals(action)) {
            ...
            if (cover != null)
                ...
                views.setImageViewResource(R.id.cover, R.drawable.radio_icon);
